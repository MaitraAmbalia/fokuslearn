    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">My Learning</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-1">Track your progress and stay focused.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white dark:bg-slate-900 rounded-xl border border-dashed border-slate-300 dark:border-slate-700">
            ...
            <Button variant="outline" onClick={() => setIsModalOpen(true)} className="dark:text-white dark:border-slate-600 dark:hover:bg-slate-800">
