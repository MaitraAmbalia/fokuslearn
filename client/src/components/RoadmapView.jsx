    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
      ...
      <div className="p-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold text-slate-900 dark:text-white">Course Progress</h3>
          ...
          {visibleVideos.map((video, index) => {
            ...
            return (
              <motion.div
                ...
                className={`flex items-center gap-3 p-4 border-b border-slate-100 dark:border-slate-700 cursor-pointer transition-all ${isActive
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className={`text-xs mt-0.5 ${isActive ? 'text-blue-500 dark:text-blue-400' : 'text-slate-400 dark:text-slate-500'}`}>
