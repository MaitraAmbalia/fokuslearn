...
const GoalCard = ({ goal }) => {
  ...
  return (
    <Card className="hover:shadow-lg transition-all duration-300 border-slate-200 dark:border-slate-700 dark:bg-slate-800 overflow-hidden flex flex-col h-full group">
      ...
      <CardHeader className="p-4 pb-2">
        <CardTitle className="text-lg font-bold line-clamp-2 leading-tight group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-400 transition-colors">
          {goal.title}
        </CardTitle>
